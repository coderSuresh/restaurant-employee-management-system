        ...
        <div class="body">
            ...
            <div class="filter-row">
                ...
                <div class="filter-drop-menu">
                     <form action="./filter-pos.php" method="post" class="filter-form">
                ...
                <!-- ======search start -->
                <form action="./search-pos.php" method="post" class="form search-form">
                    <div class="search">
            ...
            <div class="table-container">
                ...
                <table>
                    <?php
                        ...
                        if(isset($_SESSION['p_emp_list'])) {
                            $pos = $_SESSION['p_emp_list'];
                            $_SESSION['pos'] = $pos;
                        } 
                        $p_id = $_SESSION['pos'];
