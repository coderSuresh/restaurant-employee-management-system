   <aside class="sidebar">
            <div class="menu-container">
                <div class="admin-info">
                    ...
                    <div>
                        <p class="admin-name">Khadga Gupta</p>
            ...
            <div class="sidebar-items">
                ...
                <hr class="sidebar-hr">
                <a href="./add-employee.php" title="Add Employee">
                    <img src="./images/add.svg" alt="add employee">
                    <p class="sidebar-label">Add Employee</p>
                </a>
                <a href="./employees.php" title="View Employee">
                ...
                <hr class="sidebar-hr">
                <a href="./add-department.php" title="Add Department">
                    <img src="./images/add.svg" alt="add Department">
                    <p class="sidebar-label">Add Department</p>
                </a>
                <a href="./departments.php" title="View Department">
